...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2023 at 06:27 PM
...
--
-- Dumping data for table `0438_banner`
--

INSERT INTO `0438_banner` (`id`, `name`, `link`, `position`, `image`, `sort_order`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
INSERT INTO `0438_brand` (`id`, `name`, `slug`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
(16, 'dsadadasd', 'âffaffa', 1, '', 'fafsafsf', '2023-10-23 09:08:18', 1, '2023-10-23 09:08:19', NULL, 1);
...
INSERT INTO `0438_category` (`id`, `name`, `slug`, `parent_id`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(1, 'Đồ nam', 'do-nam', 0, 0, 'thoi-trang-nam.png', 'Đồ nam', '2022-11-22 18:17:31', 1, '2022-11-22 18:17:31', 0, 1),
...
--
-- Dumping data for table `0438_menu`
--

INSERT INTO `0438_menu` (`id`, `name`, `link`, `type`, `table_id`, `sort_order`, `position`, `level`, `parent_id`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(1, 'Trang chủ', 'http://localhost/NguyenManhHung_2122110438/', 'custom', 0, 2, 'mainmenu', 1, 0, '2022-11-22 05:36:05', 1, '2023-07-31 23:17:16', 1, 1),
...
INSERT INTO `0438_product` (`id`, `category_id`, `brand_id`, `name`, `slug`, `image`, `detail`, `qty`, `price`, `pricesale`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(1, 3, 1, 'ÁO LEN NAM - TOTODAY - ÁO LEN SỌC LỚN MÀU', 'ao-len-nam-totoday-ao-len-soc-lon-mau', 'ao len nam today.jpg', '<p>&Aacute;O LEN NAM - TOTODAY - &Aacute;O LEN SỌC LỚN M&Agrave;U</p>\r\n', 3, 378000.00, 378000.000, 'ÁO LEN NAM - TOTODAY - ÁO LEN SỌC LỚN MÀU', '2022-11-22 04:40:37', 1, '2022-11-22 04:40:37', 1, 1),
...
INSERT INTO `0438_user` (`id`, `name`, `username`, `password`, `email`, `gender`, `phone`, `image`, `roles`, `address`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
ALTER TABLE `0438_brand`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Mã Loại', AUTO_INCREMENT=17;
...
--
ALTER TABLE `0438_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Mã Menu', AUTO_INCREMENT=29;
...
--
ALTER TABLE `0438_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã sản phẩm', AUTO_INCREMENT=37;
